...
- Freeze background RL exception text before persisting failure state, avoiding exception-target lifetime ambiguity and preserving a deterministic error record.
- Add a regression test for background training failure persistence and enable Ruff in the locked development/CI gate.
